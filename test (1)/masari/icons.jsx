/* Minimal inline icon set (Lucide-style 16px, stroke 1.8) */
const I = (path, opts={}) => (props) => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
       strokeWidth={opts.stroke || 1.8} strokeLinecap="round" strokeLinejoin="round" {...props}>
    {path}
  </svg>
);
...
const Icons = {
  ...
  graduation: I(<><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></>),
  ...
  trash: I(<><polyline points="3 6 5 6 21 6"/><path d="M19 6l-2 14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6M14 11v6"/></>),
  ...
  chevronR: I(<polyline points="9 18 15 12 9 6"/>),
  ...
  shield: I(<><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></>),
  zoomIn: I(<><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></>),
  zoomOut: I(<><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="11" x2="14" y2="11"/></>),
  panelL: I(<><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="9" y1="3" x2="9" y2="21"/></>),
  ...
  sparkle: I(<><path d="M12 3l1.9 5.7L19 10l-5.1 1.3L12 17l-1.9-5.7L5 10l5.1-1.3z"/></>),
  ...
  pinFill: I(<><path d="M12 2 L14 10 L20 10 L15 14 L17 22 L12 17 L7 22 L9 14 L4 10 L10 10 Z" fill="currentColor"/></>, {stroke: 1.2}),
